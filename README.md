Ronana Keeb Prototype V3

A simple 65% keyboard . This project is a special homage to TGR x Singa UNIKORN 60 and OTD 356 Mini. See also the [introduction video](https://youtu.be/o677NcIUri4).
...
![Ronana Keeb layouts](./image/keyboard-layout.png)
